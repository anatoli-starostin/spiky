"""
exp161_lut_attn_v2 — LUTAttentionV2 transformer.

Each block: LUTAttentionV2 (pairs (i,j) + RelPE concat → MultiHeadLut) + LayerNorm + residual.
RelPE shared across all blocks. No FFN. n_heads=1, tph=4096, nap=4.
"""
