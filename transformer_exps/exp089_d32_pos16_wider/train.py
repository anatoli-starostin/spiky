"""
exp089_d32_pos16_wider — Fork of exp084 with wider embeddings and per-component tph.

Changes from exp084:
- embedding_dim=32 (was 24), positional_dim=16 (was 8)
- q/k/v tph=384 (was 256); out_proj tph=512 (same); ffn/unembedder tph=256 (same)
- lut_input_dim = 32+16 = 48 (was 32)
"""
import sys, os, json
import torch
...
class LUTBlock(nn.Module):
    def __init__(self, cfg, layer_idx):
        ...
        d_qk    = cfg['d_qk']                       # 16
        d_v     = cfg['d_v']                        # 16
        tph     = cfg['tables_per_head']            # 256 (ffn)
