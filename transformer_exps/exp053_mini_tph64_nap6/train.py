"""
exp053_mini_tph64_nap6 — Same as exp048 but tph=64, nap=6. Same table entries as exp048
(64×2^6=4096=16×2^8), wider shallower tables. embedding_dim=32, n_heads=4, d_qk=d_v=8,
tph=64, nap=6, single FFN, hard RankAttn t=1.0, 50k steps.
"""
import sys, os, json
import torch
