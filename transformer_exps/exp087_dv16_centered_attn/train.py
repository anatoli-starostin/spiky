"""
exp086_dv16_normalized_attn — Fork of exp084 with standard scaled dot-product attention.

Q and K are L2-normalized before attention (cosine similarity scores).
Removes RankAttention rank projection; uses q/k directly.
"""
import sys, os, json
import torch
