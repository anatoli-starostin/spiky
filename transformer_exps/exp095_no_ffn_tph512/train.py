"""
exp095_no_ffn_tph512 — Fork of exp091 with batch_size=16 and tph=512 everywhere.

Changes from exp091:
- batch_size=16 (was 128)
- qkv_tables_per_head=512 (was 384)
- out_proj_tables_per_head=512 (same)
- tables_per_head (unembedder)=512 (was 256)
- No FFN (same as exp091)
"""
import sys, os, json
import torch
