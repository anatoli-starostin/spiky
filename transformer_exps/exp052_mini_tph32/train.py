"""
exp052_mini_tph32 — Same as exp048 but tph=32. Flat comparison to exp051 recursive.
embedding_dim=32, n_heads=4, d_qk=d_v=8, tph=32, single FFN, hard RankAttn t=1.0, 50k steps.
"""
import sys, os, json
import torch
