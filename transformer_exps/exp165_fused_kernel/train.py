"""
exp164_se_recompute_mlp — fork of exp163.

self_excitement=True, recompute_in_backward=True, MLP unembedder 32->128->ReLU->vocab_size.
"""
...
class LUTTransformerV2MlpUnemb(nn.Module):
    def __init__(self):
        super().__init__()
        E = cfg['embedding_dim']
        P = cfg['positional_dim']
...
model = LUTTransformerV2MlpUnemb().to(DEVICE)
