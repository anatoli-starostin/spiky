...
class Model(nn.Module):
    def __init__(self):
        ...
        # Minimal unembedder: LayerNorm + single Linear. Drops the hidden
        # ReLU layer to measure how much the non-linear MLP contributes
        # vs just a learnable readout from the LUT-transformer representation.
