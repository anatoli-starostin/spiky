"""
exp128_residual_linear_unemb — Fork of exp091.

Changes from exp091:
- Standard residual connections in LUTBlock (x = x + attn_out)
- Linear unembedder: nn.Linear(d, vocab_size) instead of MultiHeadLut
- No intermediate state collection or concatenation
"""
import sys, os, json
import torch
...
def make_lut(input_dim, n_heads, n_outputs, tables_per_head, cfg, seed_offset=0):
    return MultiHeadLut(
        ...
        shuffle_per_head=cfg.get('shuffle_per_head', True),
