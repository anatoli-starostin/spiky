"""
exp162_mlp_unemb — fork of exp152.

2-layer MLP unembedder: embedding_dim -> 128 -> ReLU -> vocab_size.
No quantization regularization. bs=32, 50k steps.
"""
...
class LUTTransformerMlpUnemb(nn.Module):
...
model = LUTTransformerMlpUnemb().to(DEVICE)
