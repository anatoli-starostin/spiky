...
class Model(nn.Module):
    def __init__(self):
        super().__init__()
        # Output embedding can be narrower than E (cheaper MSE comparison).
        ...
        # D2V (Borda + LN) compresses ±1 pair-dominance back to an E_OUT-dim
        # continuous vector. Logits = -||pair_vec - emb_v||².
        self.final_d2v = DominanceToVector(E_OUT)
