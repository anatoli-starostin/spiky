"""
exp039_rank_double_ffn_t1 — RankAttention (temperature=1.0), smooth_mode=False,
n_alternatives=1, double FFN (no double-FFN residual).
"""
import sys, os, json
import torch
...
class LUTBlock(nn.Module):
    """Single transformer block: q/k/v LUTs → RankAttention → out_proj LUT → double FFN LUT."""
    ...
    def __init__(self, cfg, layer_idx):
        ...
        self.rank_attn = RankAttention(d_head, smooth_mode=cfg["smooth_mode"], temperature=1.0)
        self.n_heads = h
        self.d_head = d_head
        self.d = d
