"""
exp118_multiscale_nap3 — Fork of exp113.

Changes from exp113:
- MULTISCALE anchor sampling policy
- nap=3 (auto-computes: q/k/v 360 tph, out_proj 651 tph)
"""
import sys, os, json
import torch
...
class LUTBlock(nn.Module):
    def __init__(self, cfg, layer_idx):
        ...
        d_qk    = cfg['d_qk']                       # 16
        d_v     = cfg['d_v']                        # 16
        tph_qkv = cfg['qkv_tables_per_head']        # 2048 (auto->360)
