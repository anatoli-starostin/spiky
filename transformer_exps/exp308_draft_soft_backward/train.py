"""exp307 -- exp299 arch+hparams, DraftBPLUTO optimizer.

DraftBPLUTO: fixed-scale latent (mx=1, scale=448, implicit ±1 clamp) +
per-weight fp8 m,v with per-table scale. Pure-PyTorch. Goal: reproduce
exp299's val ~1.527 without the regressed per-table-latent code path.
"""
