...
class Model(nn.Module):
    def __init__(self):
        ...
        # by Linear(C(FINAL_N_OUT,2), VOCAB_SIZE) on the raw pair-dominance.
        fcfg = cfg['final_lut']
        ...
        self.unembed_linear = nn.Linear(self.final_p, VOCAB_SIZE)
    ...
    def forward(self, tokens):
        ...
        logits = self.unembed_linear(final_dom.squeeze(1))          # [B*T, V]
