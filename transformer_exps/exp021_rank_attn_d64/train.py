"""
exp021_rank_attn_d64 — Same as exp020 but embedding_dim=64, tables_per_head=64.
q/k projected through pairwise rank features (M=all d_head*(d_head-1)//2 pairs)
...
class LUTBlock(nn.Module):
    ...
    def __init__(self, cfg, layer_idx):
        ...
        self.rank_attn = RankAttention(d_head, smooth_mode=cfg['smooth_mode'])
        self.n_heads = h
        self.d_head = d_head
        self.d = d
