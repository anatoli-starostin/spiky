...
# exp330: force CANONICAL_DISTINCT (legacy per-table i.i.d.) sampling to match
# exp314's original behavior. CANONICAL_FULL_COVERAGE is now the library default.
_SAMPLING_POLICY = AnchorSamplingPolicy.CANONICAL_DISTINCT
...
def _make_qk(seed_offset):
    return BitPermutationLUT(
        ...
        device=DEVICE,
        anchor_sampling_policy=_SAMPLING_POLICY,
    )
