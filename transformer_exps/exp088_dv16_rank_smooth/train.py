"""
exp088_dv16_rank_smooth — Fork of exp084 with smooth RankAttention.

Changes from exp084:
- RankAttention smooth_mode=True (soft rank features instead of sign/STE)
"""
import sys, os, json
import torch
...
class LUTBlock(nn.Module):
    def __init__(self, cfg, layer_idx):
        ...
        self.rank_attn = RankAttention(d_qk, d_v, smooth_mode=True, temperature=1.0)
        self.n_heads = h
        self.d_qk = d_qk
        self.d_v = d_v
        self.d = d
