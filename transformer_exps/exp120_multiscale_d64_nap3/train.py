"""
exp120_multiscale_d64_nap3 — Fork of exp119.

Changes from exp119:
- embedding_dim=64, positional_dim=64 → interleaved input_dim=128 (auto->2667 tph)
- d_qk=d_v=32 → out_proj input_dim=128 (auto->2667 tph)
"""
import sys, os, json
import torch
...
class LUTBlock(nn.Module):
    def __init__(self, cfg, layer_idx):
        ...
        d_qk    = cfg['d_qk']                       # 32
        d_v     = cfg['d_v']                        # 32
        tph_qkv = cfg['qkv_tables_per_head']        # 4096 (auto->2667)
        tph_op  = cfg['out_proj_tables_per_head']   # 4096 (auto->2667)
