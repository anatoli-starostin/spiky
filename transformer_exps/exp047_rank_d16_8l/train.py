"""
exp047_rank_d16_8l — embedding_dim=16, n_heads=4, 8 layers, RankAttention d_qk=d_v=16 (120 pairs),
hard RankAttn (temperature=1.0, smooth_mode=False), LUT non-smooth, double FFN.
q/k/v tph=48, out/ffn tph=192, unembedder tph=128. ~46M params budget.
"""
import sys, os, json
import torch
