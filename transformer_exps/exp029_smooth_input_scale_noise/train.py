"""
exp029_smooth_input_scale_noise — Same as exp023 but with input_scale_noise=0.5 (U[0.5,1.5] per batch element).
"""
import sys, os, json
import torch
...
def make_lut(input_dim, n_heads, n_outputs, cfg, seed_offset=0):
    return MultiHeadLut(
        ...
        output_scale_noise=cfg.get('output_scale_noise', 0.0),
