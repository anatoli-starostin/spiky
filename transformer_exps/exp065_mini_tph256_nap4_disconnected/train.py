"""
exp065_mini_tph256_nap4_disconnected — Same as exp059 but DISCONNECTED anchor sampling policy.
All 2*nap indices per table are distinct. tph=256, nap=4, ~5M params, 50k steps.
"""
import sys, os, json
import torch
...
def make_lut(input_dim, n_heads, n_outputs, cfg, seed_offset=0):
    return MultiHeadLut(
        ...
        anchor_sampling_policy=AnchorSamplingPolicy.DISCONNECTED,
