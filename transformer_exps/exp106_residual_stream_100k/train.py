"""
exp106_residual_stream_100k — Fork of exp104.

Changes from exp104:
- up_proj layers use lr=0.001 (same as unembedder, vs lr=0.0001 for LUT layers)
"""
import sys, os, json
import torch
...
optimizer = torch.optim.Adam([
    ...
    {'params': model.up_projs.parameters(),   'lr': cfg['lr_up_proj']},
    {'params': [p for n, p in model.named_parameters()
                if not n.startswith('unembedder') and not n.startswith('up_projs')],
     'lr': cfg['lr']},
])
