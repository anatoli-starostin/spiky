"""
exp100_nap6_linear_unemb — Fork of exp097 with nn.Linear unembedder (was MultiHeadLut).

Changes from exp097:
- unembedder is nn.Linear(embedding_dim, vocab_size) instead of MultiHeadLut
"""
import sys, os, json
import torch
