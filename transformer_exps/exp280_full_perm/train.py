"""
exp280_full_perm — Fully permutational architecture. Q/K/V/out_proj all PermutationalLut.
RankAttention on Q/K, V outputs dominance directly (return_dominance=True).
Positional embeddings concatenated (pos_dim=16). Concat layers + MLP unembedder. ctx=32, 25K bs=64.
"""
