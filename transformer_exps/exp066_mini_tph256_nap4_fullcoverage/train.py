"""
exp066_mini_tph256_nap4_fullcoverage — Same as exp059 but FULL_COVERAGE anchor sampling.
All 496 unique pairs covered across tables. tph=256, nap=4, ~5M params, 50k steps.
"""
import sys, os, json
import torch
