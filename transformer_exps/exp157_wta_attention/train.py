"""
exp157_wta_attention — fork of exp152.

RankWTAAttention instead of RankAttention (differentiable argmax via WTALookup).
...
class LUTBlock(nn.Module):
    def __init__(self, layer_idx):
        ...
        self.rank_attn = RankWTAAttention(d_qk, d_v, smooth_mode=False, temperature=1.0, n_alternatives=cfg['n_alternatives'])
        self.n_heads = h
        self.d_qk = d_qk
        self.d_v = d_v
        self.d = d
