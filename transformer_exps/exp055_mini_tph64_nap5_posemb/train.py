"""
exp055_mini_tph64_nap5_posemb — Same as exp054 but pos embeddings initialized with
uniform(-0.1, 0.1) matching token embeddings. tph=64, nap=5, ~2.5M params, 50k steps.
"""
import sys, os, json
import torch
...
class LUTTransformerV2(nn.Module):
    ...
    def __init__(self, cfg, maxlen=CONTEXT_SIZE):
        ...
        pos_emb = torch.empty(1, maxlen, d).uniform_(-0.1, 0.1)
