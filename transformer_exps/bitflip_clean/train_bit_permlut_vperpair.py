"""Variant of train_bit_permlut.py using DraftBPLUTOVPerPair.
...
from spiky.lutorch.draft_bpluto import DraftBPLUTOVPerPair
...
BATCH_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), "train_bit_permlut_vperpair_batch.csv")
EVAL_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), "train_bit_permlut_vperpair_eval.csv")
