"""
exp067_mini_tph256_nap4_disconnected_fullcoverage — Same as exp059 but DISCONNECTED_FULL_COVERAGE
anchor sampling: all 496 unique pairs covered AND all tables disconnected (2*nap distinct indices).
tph=256, nap=4, ~5M params, 50k steps.
"""
import sys, os, json
import torch
