...
def make_score_hyper(seed_offset=0):
    ...
    lut = HyperLUT(
        ...
        n_pairs=cfg['score_n_pairs'], hidden_dim=hid,
...
def make_value_hyper(seed_offset=200):
    ...
    return HyperLUT(
        ...
        n_pairs=cfg['value_n_pairs'], hidden_dim=hid,
        temperature=temp, random_seed=cfg['random_seed']+seed_offset, device=DEVICE,
    )
...
def make_outproj_hyper(seed_offset=400):
    ...
    return HyperLUT(
        ...
        n_pairs=cfg['outproj_n_pairs'], hidden_dim=hid,
        temperature=temp, random_seed=cfg['random_seed']+seed_offset, device=DEVICE,
    )
...
print(f'Architecture: HyperLUT scores(H={H},pairs={cfg["score_n_pairs"]}) + V-HyperLUT + softmax@V + outproj-HyperLUT, hid={hid}')
