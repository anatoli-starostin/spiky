"""
exp024_smooth_rank_norm — Same as exp023 but with RankAttention (normalize_deltas=True) replacing SDPA.
"""
import sys, os, json
import torch
...
class LUTBlock(nn.Module):
    ...
    def __init__(self, cfg, layer_idx):
        ...
        self.rank_attn = RankAttention(d_head, smooth_mode=cfg['smooth_mode'], normalize_deltas=True)
        self.n_heads = h
        self.d_head = d_head
        self.d = d
