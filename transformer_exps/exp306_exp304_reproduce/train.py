...
# Note: torch.compile is NOT used here because it prevents the forward hook
# on BitPermutationLUT from firing, leaving grad_out uncaptured and bit LUTs
# frozen at init. exp299 ran without compile too.
