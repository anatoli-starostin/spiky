"""
exp071_mini_tph256_nap4_fc_nopos — Same as exp066 (tph=256, nap=4, FULL_COVERAGE) but with
NO positional encoding whatsoever. Control experiment for exp070 (pos perm). 50k steps.
"""
import sys, os, json
import torch
...
class LUTBlock(nn.Module):
    """Single transformer block with no positional encoding."""
