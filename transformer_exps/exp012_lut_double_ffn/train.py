"""
exp012_lut_double_ffn — Same as exp010 but FFN replaced with two consecutive LUTs (d->d each).
...
class LUTBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        ffn_out = self.ffn1(x.reshape(-1, E))[:, 0, :]         # [B*T, E]
        ffn_out = self.ffn2(ffn_out)[:, 0, :]                  # [B*T, E]
