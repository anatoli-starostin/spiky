...
class Model(nn.Module):
    def __init__(self):
        ...
        # Raw vote sums have std ≈ sqrt(tph*output_nap/n_outputs) at init;
        # a scalar learnable scale (init = 1/sqrt(votes_per_output)) brings
        # initial logit std to ~1.0 and lets Adam adjust afterwards.
