"""
exp068_mini_tph124_nap4_fullcoverage — FULL_COVERAGE, nap=4, tph=124.
Minimum tables for complete pair coverage (ceil(496/4)=124). Each pair appears exactly once.
~2.4M params, 50k steps.
"""
import sys, os, json
import torch
