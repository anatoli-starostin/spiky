"""
exp048_mini — Minimalistic: embedding_dim=32, n_heads=4, d_qk=d_v=8 (28 pairs),
hard RankAttn (temperature=1.0, smooth_mode=False), LUT non-smooth, tph=16, single FFN, 50k steps.
"""
import sys, os, json
import torch
