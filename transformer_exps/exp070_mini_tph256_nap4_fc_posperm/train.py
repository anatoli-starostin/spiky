"""
exp070_mini_tph256_nap4_fc_posperm — Same as exp066 (tph=256, nap=4, FULL_COVERAGE) but with
PositionalPermutation applied to q and k before attention. Fixed random permutation per position,
no extra learnable parameters. 50k steps.
"""
import sys, os, json
import torch
...
from spiky.lutorch.ranking_tools import RankAttention, PositionalPermutation
...
class LUTBlock(nn.Module):
    """Single transformer block with PositionalPermutation applied to q and k."""
    ...
    def __init__(self, cfg, layer_idx):
        ...
        self.pos_perm = PositionalPermutation(CONTEXT_SIZE, d_head, random_seed=layer_idx)
        self.n_heads = h
        self.d_head = d_head
        self.d = d
