"""
exp078_mini_fp_rank1 — Fork of exp075 with FactoredProjection rank=1 everywhere.
...
At rank=1 this is ~10x fewer projection params than LProjection for small n_outputs,
