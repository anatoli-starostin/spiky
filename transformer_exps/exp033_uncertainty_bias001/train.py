"""
exp033_uncertainty_bias001 — Same as exp023 but uncertainty_bias=0.01.
Smooth mode throughout; watch smooth/hard gap with near-zero blending weight.
"""
import sys, os, json
import torch
...
def make_lut(input_dim, n_heads, n_outputs, cfg, seed_offset=0):
    return MultiHeadLut(
        ...
        uncertainty_bias=cfg.get('uncertainty_bias', 0.5),
