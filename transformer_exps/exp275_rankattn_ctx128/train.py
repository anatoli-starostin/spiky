"""
exp275_rankattn_ctx128 — ctx=128, RankAttention on Q/K (pair-dominance projection),
regular MultiHeadLut V, PermutationalLut STE matmul out_proj. 100K bs=32.

Topology variant: Q and K go through RankAttention which projects them into
pair-dominance space before computing attention weights (so the dot product is a
"pair preference agreement" score). V stays real-valued. out_proj is PermLut STE.
"""
...
class LUTBlock(nn.Module):
    ...
    def forward(self, x, pos_emb):
        ...
        # RankAttention: Q/K → pair-dominance features → SDPA; V stays real-valued
