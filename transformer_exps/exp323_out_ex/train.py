...
print(f'Out BitPermLUTEx: in_nap={cfg["out_input_nap"]} in_tph={cfg["out_input_tph"]} '
      f'voting_nap={cfg["out_voting_nap"]} out_nap={cfg["out_output_nap"]} out_tph={cfg["out_output_tph"]} '
      f'V_ex={cfg["out_output_tph"] * (1 << cfg["out_output_nap"])}')
