"""
exp045_rank_d64 — embedding_dim=64, RankAttention d_qk=d_head=16 (120 pairs), d_v=16,
hard RankAttn (temperature=1.0, smooth_mode=False), LUT non-smooth, tph=64, double FFN.
"""
import sys, os, json
import torch
...
class LUTBlock(nn.Module):
    """Single transformer block: q/k/v LUTs → RankAttention (d_qk=d_head=16) → out_proj LUT → double FFN LUT."""
