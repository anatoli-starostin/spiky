"""nanochat_exps/exp073_d_qk48_tph512 — fork of exp072 trading d_qk for tph.

Two changes vs exp072: d_qk 64 -> 48 (D_QK_P 2016 -> 1128) and
qk_tph 256 -> 512. Smaller Q/K dominance vectors but 2x more parallel
Q/K tables per head. +37.75M params (167.05M -> 204.80M). Same rank-only
...
How to launch:
    ...
    PYTHONPATH=/home/starost/nanochat \\
        ...
        -u nanochat_exps/exp073_d_qk48_tph512/train.py \\
        > nanochat_exps/exp073_d_qk48_tph512/stdout.log 2>&1 &
"""
