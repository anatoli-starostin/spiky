"""nanochat_exps/exp233_dv48 — fork of exp223 (1.6249 @ 8K, 339M).

Single change: d_v 24 -> 48 (V LUT n_outputs doubles per head; SDPA value dim
doubles; out_proj input dim H*d_v doubles 144 -> 288). V LUT weights ~9.4M ->
~18.9M (+9.4M); out_proj LUT param count unchanged (table_dim and n_outputs
fixed). Total params ~339M -> ~349M. Tests whether bigger V helps.

Launch:
    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python -u \\
        nanochat_exps/exp233_dv48/train.py \\
        > nanochat_exps/exp233_dv48/stdout.log 2>&1 &
"""
