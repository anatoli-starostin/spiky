"""nanochat_exps/exp078_canon_48k — long-training fork of exp071 (48K steps).

Same architecture as exp071 (rank-only chain, all-LUT, 129.30M params)
but trained for 48,000 steps (6x exp071's 8K, 2x exp077's 24K).
exp077 (24K) reached 1.6267; this run tests whether the rank-only
architecture keeps improving at 48K or plateaus.

How to launch:

    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python \\
        -u nanochat_exps/exp078_canon_48k/train.py \\
        > nanochat_exps/exp078_canon_48k/stdout.log 2>&1 &
"""
