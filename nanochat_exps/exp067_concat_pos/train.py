"""nanochat_exps/exp067_concat_pos — fork of exp064 with concat pos embeddings.

Single change vs exp064: pos_emb_dim 0 -> 96. The Q/K LUT input becomes
[x; pos_emb] (192-dim) through a new LayerNorm; V and out_proj are
unchanged. Adds 6 x LayerNorm(192) = 2,304 params (total 129.31M, +0.002%).
Same fp32 numerics, same other hyperparams, same 8K steps.

How to launch:

    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python \\
        -u nanochat_exps/exp067_concat_pos/train.py \\
        > nanochat_exps/exp067_concat_pos/stdout.log 2>&1 &
"""
