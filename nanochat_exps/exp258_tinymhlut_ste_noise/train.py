"""nanochat_exps/exp234_dv32 — fork of exp223 (1.6249 @ 8K, 339M).

Single change: d_v 24 -> 32 (modest bump). V LUT outputs 32 per head; SDPA
value dim grows; out_proj input dim H*d_v: 144 -> 192. V LUT weights ~9.4M ->
~12.6M per layer × 6 layers; total params ~339M -> ~358M (+19M).

Launch:
    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python -u \\
        nanochat_exps/exp234_dv32/train.py \\
        > nanochat_exps/exp234_dv32/stdout.log 2>&1 &
"""
