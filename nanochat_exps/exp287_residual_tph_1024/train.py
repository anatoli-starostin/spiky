...
class LUTBlock(nn.Module):
    """exp286 block: dropped ffn_lut from exp285. Path is exp272/273 shape —
    out_proj -> ln_e on out_e -> {next block, residual_lut}. Other knobs (d_v,
    v_tph, out_proj tph, residual_lut tph) kept from exp285."""
    def __init__(self, layer_idx):
        ...
        # Post-norm on E-stream output at block end; feeds both next-block
        # x_lut AND residual_lut.
    ...
    def forward(self, x, pos_emb):
        ...
        # Post-norm on E-stream output; same LN'd value feeds residual_lut.
...
print('ffn_lut: REMOVED in exp286')
