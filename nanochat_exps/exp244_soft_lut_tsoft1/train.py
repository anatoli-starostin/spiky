"""nanochat_exps/exp244_soft_lut_tsoft1 — fork of exp243 with T_soft=1.0.

Single change: soft_score_temp 0.5 -> 1.0. Forward identical (hard=True
makes forward T_soft-invariant). Backward gradient through rational sign:
  dp/drd at |rd|=1: 1/(1+1)^2 = 0.25     (was 0.22 at T_soft=0.5)
  dp/drd at |rd|=0: 1.0                  (was 2.0 at T_soft=0.5)
  dp/drd at |rd|=5: 1/36 = 0.028         (was 0.018 at T_soft=0.5)
Higher T_soft = "smoother" gradient curve, broader effective receptive band
around rd=0 with less peakiness. Exp243 won at T_soft=0.5; this checks
whether even more spread helps.

All else: hard=True, T_sel=0.5, gumbel=False, nap=8 V, bf16+compile.

Launch:
    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python -u \\
        nanochat_exps/exp244_soft_lut_tsoft1/train.py \\
        > nanochat_exps/exp244_soft_lut_tsoft1/stdout.log 2>&1 &
"""
