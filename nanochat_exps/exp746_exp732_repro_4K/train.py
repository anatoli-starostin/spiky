"""exp746 — verbatim rerun of exp732 to measure reproducibility / noise floor.

Same code, same config, same seed (42) as exp732 (1.3912). If exp746 matches
within ~0.5 mb, the recipe is reproducible and the exp737 v2 (1.3872) advantage
is real (~4 mb). Otherwise we have a wider noise floor to account for in
comparisons across exp732-family runs.
"""
