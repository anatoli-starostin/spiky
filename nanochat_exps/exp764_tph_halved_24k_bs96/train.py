"""exp760 — exp756 trained from scratch for 24K steps (1.5x longer horizon).

Fork of exp756 (E=192 hard, 16K, 1.2301). Single change: n_steps
16000 -> 24000. Extended cosine schedule (peak now at step 2400). Tests
whether training from scratch at extended horizon beats the resume + 8K
continuation (exp759). Expected wallclock ~5.1 h. Running in parallel
with exp759 — both will share GPU.
