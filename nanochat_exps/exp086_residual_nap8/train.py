"""nanochat_exps/exp086_residual_nap8 — fork of exp085 with nap=8 residual.

Single change vs exp085: residual_input_nap = 8 (was 6). Each residual
table grows from 2^6=64 to 2^8=256 weight rows (4x weights per table).
Inverse-concat order and anchor-inheritance from layer (i-1) -> layer i
are unchanged.
...
How to launch:
    ...
    PYTHONPATH=/home/starost/nanochat \\
        ...
        -u nanochat_exps/exp086_residual_nap8/train.py \\
        > nanochat_exps/exp086_residual_nap8/stdout.log 2>&1 &
"""
