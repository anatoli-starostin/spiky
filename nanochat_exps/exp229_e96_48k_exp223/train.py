"""nanochat_exps/exp229_e96_48k_exp223 — fork of exp223 (1.6249 @ 8K, 339M).

Single change: n_steps 8000 -> 48000 (6x). Tests capacity ceiling of the
exp223 LUT-attention architecture given 6x more training. Cosine schedule
with 10% warmup over 48K steps. Wall-clock ~4 hours.

Launch:
    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python -u \\
        nanochat_exps/exp229_e96_48k_exp223/train.py \\
        > nanochat_exps/exp229_e96_48k_exp223/stdout.log 2>&1 &
"""
