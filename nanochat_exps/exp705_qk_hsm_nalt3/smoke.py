#!/usr/bin/env python3
"""Smoke test: exp705 — exp696 with qk_lut hybrid_smooth_n_alt=3."""
...
assert cfg['qkv_hybrid_smooth_n_alt'] == 3
qkv = TinyMultiHeadLut(input_dim=E, n_heads=H, n_outputs=2 * d_qk,
                       ...
                       hybrid_smooth_n_alt=cfg['qkv_hybrid_smooth_n_alt'],
                       **kwargs)
assert qkv.weights.numel() == 3_145_728
assert qkv.hybrid_smooth_n_alt == 3
