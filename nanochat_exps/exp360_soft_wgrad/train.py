...
from spiky.lutorch.tiny_multi_head_lut import TinyMultiHeadLut, enable_soft_weight_grad  # noqa: F401
...
if cfg.get('soft_weight_grad', False):
    enable_soft_weight_grad(True)
    print('TinyMHLut: soft weight-gradient backward ENABLED (sel_soft-weighted across all K rows).')
