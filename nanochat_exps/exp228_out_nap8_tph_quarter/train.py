"""nanochat_exps/exp228_out_nap8_tph_quarter — fork of exp223 (1.6249 @ 8K, 339M).

Single change: trade out_proj's tph for nap at constant param count.
  - out_input_nap: 6 -> 8 (table_dim 64 -> 256, 4x bigger)
  - out_tph: 1024 -> 256
  - out_tph_per_layer: [2048, 2048, 1024, 1024, 1024, 1024]
                    -> [ 512,  512,  256,  256,  256,  256]
Total weights per layer = tph * 2^nap * n_outputs is unchanged. Tests whether
fewer wider tables (each looking at 8 input pairs jointly) beat more narrower
tables (6-pair lookups) at the out_proj boundary.

Launch:
    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python -u \\
        nanochat_exps/exp228_out_nap8_tph_quarter/train.py \\
        > nanochat_exps/exp228_out_nap8_tph_quarter/stdout.log 2>&1 &
"""
