#!/usr/bin/env python3
"""Smoke test: exp704 — exp696 with qk_tph 256 -> 512 (NAP=4 unchanged)."""
...
assert cfg['qkv_input_nap'] == 4 and cfg['qkv_tph'] == 512
assert qkv.weights.numel() == 6_291_456   # 6 * 512 * 16 * 128 (2x exp696)
