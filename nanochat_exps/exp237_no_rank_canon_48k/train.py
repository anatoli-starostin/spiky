"""nanochat_exps/exp237_no_rank_canon_48k — fork of exp236 (1.6042 @ 8K, 358M).

Single change: n_steps 8000 -> 48000 (6x). exp236 (no rank canon, plain LN
between blocks) was the biggest single 8K LUT win — beat vanilla 8K by 0.021.
This tests how the architecture scales. Wall-clock ~3.5 hours. Compare to
exp235 (d_v=32 + rank canon, 1.4906 @ 48K) and exp041 (vanilla 1.3406 @ 48K).

Launch:
    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python -u \\
        nanochat_exps/exp237_no_rank_canon_48k/train.py \\
        > nanochat_exps/exp237_no_rank_canon_48k/stdout.log 2>&1 &
"""
