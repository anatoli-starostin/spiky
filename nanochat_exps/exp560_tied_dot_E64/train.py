...
class Model(nn.Module):
    def __init__(self):
        ...
        self.logit_scale = nn.Parameter(torch.tensor(1.0, device=DEVICE))   # tied dot-product head
    ...
    def forward(self, tokens, targets=None, loss_reduction='mean'):
        ...
        logits = (e_hat @ self.tok_emb_E.weight.t()) * self.logit_scale   # tied dot-product
...
print(f'Total params: {n_params:,} (residual->E={E}, TIED DOT-PRODUCT head, logit=e_hat . tok_emb)')
