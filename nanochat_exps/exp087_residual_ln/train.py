"""nanochat_exps/exp087_residual_ln — fork of exp085 with per-block LayerNorm.

Single change vs exp085: each LUTBlock applies a LayerNorm(E) to the
per-block sum (out_real + res_out) before returning. All other structure
(inverse-concat residual order, anchor inheritance from layer (i-1)) is
unchanged.
...
How to launch:
    ...
    PYTHONPATH=/home/starost/nanochat \\
        ...
        -u nanochat_exps/exp087_residual_ln/train.py \\
        > nanochat_exps/exp087_residual_ln/stdout.log 2>&1 &
"""
