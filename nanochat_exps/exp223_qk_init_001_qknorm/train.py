"""nanochat_exps/exp223_qk_init_001_qknorm — fork of exp220 (1.6403 @ 8K, 339M).

Single change: revert qk_lut_init_std from 0.02 back to the standard 0.001
(same as V/out_proj). Keeps q_norm + k_norm and plain SDPA. Tests whether the
init bump in exp220 was actually needed once QK-norm is in place — i.e. is
QK-norm doing all the work?

Launch:
    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python -u \\
        nanochat_exps/exp223_qk_init_001_qknorm/train.py \\
        > nanochat_exps/exp223_qk_init_001_qknorm/stdout.log 2>&1 &
"""
