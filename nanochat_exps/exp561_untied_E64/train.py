...
class Model(nn.Module):
    def __init__(self):
        ...
        self.unembedder = nn.Linear(E, VOCAB_SIZE, bias=False)   # UNTIED Linear(E, V) head
    ...
    def forward(self, tokens, targets=None, loss_reduction='mean'):
        ...
        logits = self.unembedder(e_hat)                              # UNTIED Linear(E, V)
...
print(f'Total params: {n_params:,} (residual->E={E}=D, UNTIED Linear({E}, V) head)')
