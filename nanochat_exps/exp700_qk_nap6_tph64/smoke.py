#!/usr/bin/env python3
"""Smoke test: exp700 — exp696 with qk_lut NAP=6,tph=64 (param-matched deep-shape)."""
...
assert cfg['qkv_input_nap'] == 6 and cfg['qkv_tph'] == 64
assert qkv.weights.numel() == 3_145_728   # 6 * 64 * 64 * 128 (param-matched to exp696)
