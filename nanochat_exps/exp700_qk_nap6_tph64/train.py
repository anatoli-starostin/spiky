"""exp700 — fork of exp696 (1.4247 @ 100.7M) with qk_lut deep-shape swap.

Single change: qk_lut (NAP=4, tph=256) -> (NAP=6, tph=64). Param-matched
(6*256*16*128 = 6*64*64*128 = 3.15M/L), bandwidth 4x less per layer
(768 KB/L -> 192 KB/L). Counterpart to exp699 (NAP=3, tph=512 = wide, which
lost). Tests if very-deep qk (K=64 rows per table, few tables) wins.
"""
