...
class Model(nn.Module):
    def __init__(self):
        ...
        # Small gamma_emb init so logit scale starts ~1.0 (avoids the exp572/573
        # "random-peaked-on-wrong-vocab gives CE=log(V)" warmup pathology).
        self.ln_emb_v2d.weight.data.fill_(0.1)
...
P_v2d = E * (E - 1) // 2
print(f'V2D-TIED head (exp576): logits = ln_x_v2d(V2D(x_lut)) @ ln_emb_v2d(V2D(tok_emb_E)).T; V2D dim P=E*(E-1)/2={P_v2d}, ln_emb_v2d.gamma init=0.1; RoPE base={_ROPE_BASE}')
