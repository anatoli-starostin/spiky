...
# Load + freeze vanilla teacher's unembedder (= tied tok_emb in exp416).
...
if _TEACHER_CKPT:
    ...
    print(f'TEACHER: loaded head.weight from {_TEACHER_CKPT}; shape={tuple(teacher_head_w.shape)}; frozen')
