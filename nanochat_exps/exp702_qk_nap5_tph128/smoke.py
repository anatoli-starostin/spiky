#!/usr/bin/env python3
"""Smoke test: exp702 — exp696 with qk NAP=5, tph=128 (param-matched middle-shape)."""
...
assert erl.weights.numel() == 3_145_728, erl.weights.shape    # 1 * 256 * 32 * 384
...
assert cfg['qkv_input_nap'] == 5 and cfg['qkv_tph'] == 128
assert qkv.weights.numel() == 3_145_728   # 6 * 128 * 32 * 128 (param-matched to exp696)
...
print(f'  delta vs exp693: +{erl.weights.numel()/1e6:.2f}M (emb_resid_lut)')
