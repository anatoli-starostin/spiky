"""exp702 — fork of exp696 (1.4247 @ 100.7M) with qk NAP=5, tph=128.

Single change: qk_lut shape (NAP=4, tph=256) -> (NAP=5, tph=128). Param-matched
at 3.15M/L. Middle ground between exp699 (wide NAP=3) and exp700 (deep NAP=6),
both of which lost.
"""
