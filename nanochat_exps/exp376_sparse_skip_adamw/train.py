...
from sparse_skip_adamw import SparseSkipAdamW
...
lut_optimizer = SparseSkipAdamW(lut_group, lr=_LUT_LR, betas=(_LUT_BETA1, _LUT_BETA2),
                                eps=1e-8, weight_decay=0.0)
...
print(
    f'optimizer groups: '
    f'lut={sum(p.numel() for p in lut_params):,} -> SparseSkipAdamW(lr={_LUT_LR}, betas=({_LUT_BETA1},{_LUT_BETA2})) [{n_hooked} TinyMHLut modules hooked] | '
