"""nanochat_exps/exp245_soft_lut_tsoft01 — fork of exp243 with T_soft=0.1.

Single change: soft_score_temp 0.5 -> 0.1. Forward unchanged (hard=True).
Backward gradient through rational sign:
  T_soft  dp/drd@|rd|=1   dp/drd@|rd|=0   trend
   0.01     0.0098            100         too peaked, near-zero away from origin
   0.1      0.083             10          peaked near origin
   0.5      0.22              2           best so far (exp243 = 1.6089)
   1.0      0.25              1           too smooth (exp244 trailing)
T_soft=0.1 sits between the broken (0.01) and winning (0.5) regimes —
checks whether a more peaked gradient (concentrated near rd=0) helps.
...
Launch:
    PYTHONPATH=/home/starost/nanochat \\
        ...
        nanochat_exps/exp245_soft_lut_tsoft01/train.py \\
        > nanochat_exps/exp245_soft_lut_tsoft01/stdout.log 2>&1 &
"""
