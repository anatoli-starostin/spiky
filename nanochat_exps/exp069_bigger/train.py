"""nanochat_exps/exp069_bigger — scaled-up fork of exp064.

Capacity scaling: input_nap 6/7/6 -> 8/8/8 (table input space 64/128/64 ->
256 entries), tph also doubled at Q/K and V; out_tph schedule rescaled
[2048,2048,1024,...] -> [1024,1024,512,...] so each table is half-size but
4x deeper input. Total params 129.30M -> 500.50M (~3.9x). Tests how much
room there is for capacity scaling at this 8K-step budget.

How to launch:

    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python \\
        -u nanochat_exps/exp069_bigger/train.py \\
        > nanochat_exps/exp069_bigger/stdout.log 2>&1 &
"""
