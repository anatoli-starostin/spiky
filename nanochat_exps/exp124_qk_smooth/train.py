...
class _MHLutSparseScatter(nn.Module):
    """MultiHeadLut(return_per_table_outputs=True) + i.i.d. SparseScatter,
    used here for qk_joint only (smooth_mode=True, n_alternatives=3)."""
