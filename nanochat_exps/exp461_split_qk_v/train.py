...
def _make_qk(layer_idx, seed_offset):
    # Split design: qk_lut produces ONLY q,k (no joint v branch). v comes solely
    # from v_lut. Homogeneous outputs -> clean to sparsify per-table later.
...
class LUTBlock(nn.Module):
    ...
    def forward(self, x, cos, sin):
        ...
        v_vec = v_lut_out                              # split design: v from v_lut only
