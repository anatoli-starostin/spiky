...
def _make_sparse_lut(input_dim, n_heads, n_outputs, n_anchor_pairs,
                     ...
                     max_anchor_distance=None, aligned_local_scatter=False,
                     local_window_starts="linspace"):
    ...
    return TinyMultiHeadLut(
        ...
        aligned_local_scatter=aligned_local_scatter,
    )
...
def _make_qk_joint(layer_idx, seed_offset):
    ...
    return _make_sparse_lut(
        ...
        max_anchor_distance=cfg.get('qk_max_anchor_distance'),
        aligned_local_scatter=cfg.get('qk_aligned_local_scatter', False),
    )
...
def _make_v(layer_idx, seed_offset):
    return _make_sparse_lut(
        ...
        lut_seed=cfg['random_seed'] + seed_offset,
        scatter_seed=cfg['random_seed'] + seed_offset + 10000,
        max_anchor_distance=cfg.get('v_max_anchor_distance'),
        aligned_local_scatter=cfg.get('v_aligned_local_scatter', False),
    )
...
def _make_out(layer_idx, seed_offset):
    return _make_sparse_lut(
        ...
        lut_seed=cfg['random_seed'] + seed_offset,
        scatter_seed=cfg['random_seed'] + seed_offset + 10000,
        max_anchor_distance=cfg.get('out_max_anchor_distance'),
        aligned_local_scatter=cfg.get('out_aligned_local_scatter', False),
    )
