"""nanochat_exps/exp231_out_tph_2048_uniform — fork of exp223 (1.6249 @ 8K, 339M).

Single change: out_tph_per_layer flat at 2048 across ALL layers (was
[2048, 2048, 1024, 1024, 1024, 1024] — boosted in first two layers, smaller
elsewhere). Doubles the out_proj LUT capacity in the last 4 layers; nap and
qk/v settings unchanged.

Launch:
    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python -u \\
        nanochat_exps/exp231_out_tph_2048_uniform/train.py \\
        > nanochat_exps/exp231_out_tph_2048_uniform/stdout.log 2>&1 &
"""
