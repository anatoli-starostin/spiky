...
from spiky.lutorch.tiny_multi_head_lut import TinyMultiHeadLut, set_per_row_grad_norm  # noqa: F401
...
if cfg.get('per_row_grad_norm', False):
    set_per_row_grad_norm(True)
    print('TinyMHLut: per-row visit-count gradient normalization ENABLED '
          '(weight gradient = mean over visiting tokens, not sum).')
