"""nanochat_exps/exp077_canon_24k — long-training fork of exp071.

Same architecture as exp071 (rank-only chain, all-LUT, 129.30M params)
but trained for 24,000 steps (3x exp071's 8K budget). Tests whether the
rank-canonicalize-everywhere pipeline continues to improve past 8K or
plateaus.
...
How to launch:
    ...
    PYTHONPATH=/home/starost/nanochat \\
        ...
        -u nanochat_exps/exp077_canon_24k/train.py \\
        > nanochat_exps/exp077_canon_24k/stdout.log 2>&1 &
"""
