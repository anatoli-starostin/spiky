...
from input_noise import install_input_noise_hooks
_INPUT_NOISE_SIGMA = float(cfg.get('input_noise_sigma', 0.05))
...
n_noise = install_input_noise_hooks(model, _INPUT_NOISE_SIGMA)
print(
    f'optimizer groups: '
...
print(f'Input-noise pre-hooks installed on {n_noise} modules, sigma={_INPUT_NOISE_SIGMA}')
