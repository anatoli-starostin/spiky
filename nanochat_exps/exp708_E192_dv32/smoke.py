#!/usr/bin/env python3
"""Smoke test: exp708 — exp696 with E=192, d_v=32 (H*d_v=192=E preserved)."""
...
N_L = cfg['num_layers']
assert E == 192 and D == 384 and d_v == 32 and H * d_v == E
...
assert vl.weights.numel() == 3_145_728   # 6 * 256 * 64 * 32 (d_v 24->32)
...
assert op.weights.numel() == 6_291_456   # 1 * 512 * 64 * 192 (E 144->192)
...
print(f'  delta vs exp696 LUT: +14.16M (v_lut +0.79M/layer, out_proj +1.57M/layer)')
...
o = op(xa); r = rl(x)
assert o.shape == (B*T, 1, E), o.shape
