"""exp693 — fork of exp692 (out_tph=512) with v_tph 512 -> 256.

Cuts v_lut tables and bandwidth in half on top of exp692's out_proj cut. -14.16M
params -> ~97.5M total (lands in <100M tier).
...
Architecture (dual-stream per-layer residual_lut):
  - LUTBlock per layer:
      ...
      v_lut        TinyMHLut(soft, NAP=6, tph=256) -> d_v   # <-- the change (was 512)
