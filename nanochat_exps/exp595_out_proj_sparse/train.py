...
def _make_out(layer_idx, seed_offset):
    return TinyMultiHeadLut(
        input_dim=H * d_v,
        n_heads=1,
        n_outputs=cfg['out_n_sparse'],
        sparse_scatter_n_outputs=E,
        sparse_scatter_seed=cfg['out_sparse_seed_base'] + layer_idx,
...
print(f'out_proj     TinyMHLut(soft, SPARSE-SCATTER): in_nap={cfg["out_input_nap"]} tph={cfg["out_tph"]} n_out(local)={cfg["out_n_sparse"]} -> sparse_scatter_n_outputs=E={E}')
