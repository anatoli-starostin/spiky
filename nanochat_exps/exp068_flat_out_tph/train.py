"""nanochat_exps/exp068_flat_out_tph — fork of exp064 with flat out_tph=1024.

Single change vs exp064: out_tph_per_layer goes from
[2048, 2048, 1024, 1024, 1024, 1024] to all-1024. Saves 12.58M params
(129.30M -> 116.72M). Measures how much of exp064's win came from the
extra capacity at the bottom two layers' out_proj LUT.

How to launch:

    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python \\
        -u nanochat_exps/exp068_flat_out_tph/train.py \\
        > nanochat_exps/exp068_flat_out_tph/stdout.log 2>&1 &
"""
