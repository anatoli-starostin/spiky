...
class V2DSDPABlock(nn.Module):
    ...
    def __init__(self, layer_idx: int):
        ...
        # Q, K can have a head_dim independent of V. V's head_dim must be E/H so
        # heads concat back to E for the residual.
