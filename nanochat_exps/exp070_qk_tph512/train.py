"""nanochat_exps/exp070_qk_tph512 — fork of exp064 with doubled Q/K tph.

Single change vs exp064: qk_tph 256 -> 512. Doubles the number of parallel
Q/K ranking tables per head with the same anchor-pair input space (nap=6).
+37.75M params (129.30M -> 167.05M, +29%). Cleanest 'tph is king' probe.

How to launch:

    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python \\
        -u nanochat_exps/exp070_qk_tph512/train.py \\
        > nanochat_exps/exp070_qk_tph512/stdout.log 2>&1 &
"""
