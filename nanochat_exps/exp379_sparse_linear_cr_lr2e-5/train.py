...
print(
    f'optimizer groups: '
    f'lut={sum(p.numel() for p in lut_params):,} -> SparseAmplifiedAdamW(lr={_LUT_LR}, betas=({_LUT_BETA1},{_LUT_BETA2}), mode={_SPARSE_MODE}, kappa={_SPARSE_KAPPA}) [{n_hooked} TinyMHLut modules hooked] | '
