#!/usr/bin/env python3
"""Smoke test: exp703 — exp696 with qk_tph 256 -> 128 (NAP=4 unchanged)."""
...
assert cfg['qkv_input_nap'] == 4 and cfg['qkv_tph'] == 128
assert qkv.weights.numel() == 1_572_864   # 6 * 128 * 16 * 128 (half of exp696's 3.15M)
