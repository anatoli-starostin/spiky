"""exp703 — fork of exp696 (1.4247 @ 100.7M) with qk_tph 256 -> 128.

Single change: halves qk_lut tables (NAP=4 kept at sweet spot). qk/L 3.15M ->
1.57M, total goes 100.7M -> 91.2M (-9.4M).
"""
