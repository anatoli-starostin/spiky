"""nanochat_exps/exp480_ordered_quadruples_nap6_2xtph — fork of exp475.

SINGLE change: all 4 TinyMultiHeadLut -> TinyOrderedMultiHeadLut(CONNECTED_QUADRUPLES).
NAP=6 with CONNECTED_QUADRUPLES -> 2 triplets/table, max_orders=36 (vs 64).
...
# --- LUT factories (all TinyOrderedMultiHeadLut, CONNECTED_QUADRUPLES) ----------
_ORDERED_KWARGS = dict(
    weight_dtype=torch.float32,
    anchor_sampling_policy=AnchorSamplingPolicy.CONNECTED_QUADRUPLES,
...
print(f'TinyOrderedMHLut CONNECTED_QUADRUPLES NAP=6: {_max_orders_info()}')
