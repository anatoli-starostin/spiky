"""nanochat_exps/exp235_dv32_48k — fork of exp234 (1.6212 @ 8K, 358M, LUT 8K SOTA).

Single change: n_steps 8000 -> 48000 (6x). 358M params, d_v=32. Cosine + 10%
warmup over 48K. Tests capacity ceiling of the d_v=32 recipe given 6x more
training. Wall-clock ~4 hours. Compare to exp229 (1.4958 @ 48K, exp223 lineage,
d_v=24) and exp041 (vanilla 1.3409 @ 48K).

Launch:
    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python -u \\
        nanochat_exps/exp235_dv32_48k/train.py \\
        > nanochat_exps/exp235_dv32_48k/stdout.log 2>&1 &
"""
