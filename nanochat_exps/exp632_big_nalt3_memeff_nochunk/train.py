import spiky.lutorch.tiny_multi_head_lut as _mht
_mht._HYBRID_SMOOTH_FWD_B_CHUNK = 8192
_mht._HYBRID_SMOOTH_BWD_B_CHUNK = 8192
...
_TINY_SOFT_KWARGS = dict(
    ...
    hybrid_smooth_autograd=cfg.get('hybrid_smooth_autograd', False),
    hybrid_smooth_save_memory=cfg.get("hybrid_smooth_save_memory", False),
    hybrid_smooth_dense_input_grad=cfg.get("hybrid_smooth_dense_input_grad", False),
)
