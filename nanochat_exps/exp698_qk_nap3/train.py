"""exp698 — fork of exp696 (1.4247 @ 100.7M) with qkv_input_nap 4 -> 3.

Single change: qk_lut rows-per-table 16 -> 8, saves -9.43M params (~91.2M total).
Tests qk capacity sensitivity. emb_resid_lut and the rest of exp696's architecture
unchanged.
"""
