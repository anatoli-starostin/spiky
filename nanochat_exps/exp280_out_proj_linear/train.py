...
def _make_out(layer_idx, seed_offset):
    """Plain Linear(H*d_v -> E) — replaces the TinyMHLut out_proj for this experiment.
    Tests whether the LUT-based out_proj was the bottleneck vs a dense matmul."""
    return nn.Linear(H * d_v, E, bias=False)
...
class LUTBlock(nn.Module):
    ...
    def forward(self, x, pos_emb):
        ...
        out_e  = self.out_proj(out_in)                                # [B*T, E] — plain Linear
...
print(f'out_proj nn.Linear(in={H*d_v}, out={E}, bias=False)   [REPLACES TinyMHLut for this exp]')
