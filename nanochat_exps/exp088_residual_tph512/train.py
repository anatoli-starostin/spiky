"""nanochat_exps/exp088_residual_tph512 — fork of exp087 with 2x residual tables.

Single change vs exp087: residual_tph_per_layer_factor 256 -> 512.
Each LUTBlock i's residual_lut now has 512*(i+1) tables (nap=6
unchanged). Anchor inheritance and per-block LayerNorm unchanged.

How to launch:

    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python \\
        -u nanochat_exps/exp088_residual_tph512/train.py \\
        > nanochat_exps/exp088_residual_tph512/stdout.log 2>&1 &
"""
