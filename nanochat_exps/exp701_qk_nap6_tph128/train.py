"""exp701 — fork of exp696 (1.4247 @ 100.7M) with qk_lut NAP=6, tph=128.

NOT param-matched: qk per-layer params 3.15M -> 6.29M (2x). Total +18.87M ->
~119.5M. Tests if larger qk capacity at NAP=6 (deeper rows per table) pays off
when given more tables than the param-matched NAP=6/tph=64 of exp700.
"""
