#!/usr/bin/env python3
"""Smoke test: exp701 — exp696 with qk NAP=6, tph=128 (2x qk params)."""
...
assert cfg['qkv_input_nap'] == 6 and cfg['qkv_tph'] == 128
assert qkv.weights.numel() == 6_291_456   # 6 * 128 * 64 * 128 (2x exp696's 3.15M)
