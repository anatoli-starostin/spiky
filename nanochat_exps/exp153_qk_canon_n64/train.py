"""nanochat_exps/exp153_qk_canon_n64 — fork of exp152.

Single change: qk_n_sparse_outputs 32 -> 64. Matches exp144's qk_lut
weight budget exactly (~226.5M qk weights, total ~392M).

How to launch:

    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python \\
        -u nanochat_exps/exp153_qk_canon_n64/train.py \\
        > nanochat_exps/exp153_qk_canon_n64/stdout.log 2>&1 &
"""
