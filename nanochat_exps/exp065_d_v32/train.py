"""nanochat_exps/exp065_d_v32 — fork of exp064 with d_v 16 -> 32.

Same architecture as exp064 (raw V into SDPA, no V dominance). Single
config change: d_v 16 -> 32. V LUT n_outputs doubles, +18.87M params
(129.30M -> 148.18M). out_proj input dimension widens 96 -> 192 (anchors
only; LUT weights unchanged). Q/K unchanged. Same fp32 numerics, same
hyperparams, same 8K steps.

How to launch:

    PYTHONPATH=/home/starost/nanochat \\
        /home/starost/spiky/.venv/bin/python \\
        -u nanochat_exps/exp065_d_v32/train.py \\
        > nanochat_exps/exp065_d_v32/stdout.log 2>&1 &
"""
