...
QK_V2D_N_PAIRS = cfg.get('qk_v2d_n_pairs', None)
D_QK_P      = QK_V2D_N_PAIRS if QK_V2D_N_PAIRS is not None else d_qk * (d_qk - 1) // 2
...
print(f'QK V2D mode:        {"per-head sparse n_pairs=" + str(QK_V2D_N_PAIRS) if QK_V2D_N_PAIRS is not None else "full d_qk*(d_qk-1)/2=" + str(D_QK_P)} -> D_QK_P={D_QK_P}')
