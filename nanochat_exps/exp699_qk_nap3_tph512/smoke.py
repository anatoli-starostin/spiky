#!/usr/bin/env python3
"""Smoke test: exp699 — exp696 with qk_lut NAP=3,tph=512 (param-matched wide-shape)."""
...
assert cfg['qkv_input_nap'] == 3 and cfg['qkv_tph'] == 512
assert qkv.weights.numel() == 3_145_728   # 6 * 512 * 8 * 128 (same as exp696)
