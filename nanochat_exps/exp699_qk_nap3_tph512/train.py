"""exp699 — fork of exp696 (1.4247 @ 100.7M) with qk_lut wide-vs-deep swap.

Single change: qk_lut shape (NAP=4, tph=256) -> (NAP=3, tph=512). Param-matched
(6*256*16*128 = 6*512*8*128 = 3.15M/L), bandwidth doubles per layer. Tests
whether at exp696 scale qk_lut prefers wide (more tables, fewer rows/table).
"""
