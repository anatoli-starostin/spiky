"""CUDA extension for the int8 power-of-two LUT read -- hardware-gated, never raises.
...
csrc/pow2_int8_read.cu provides
  ...
  * scalars     the forward of the spiky_lutorch::p2_scalars custom op (pow2_scalar_op): p2::table_scalars for every
