"""Evaluate exp754 checkpoint (trained with forward_mode=hybrid_smooth) in
...
EXP_DIR = "/home/starost/spiky/nanochat_exps/exp754_exp752_hybrid_smooth_16k"
...
print(f"Loaded exp754 checkpoint @ step {ckpt['step']}, training-best soft={ckpt['best_val_bpb']:.4f}")
