...
def actor_init(key, n_buckets, n_det, tph, heads, delay_init_std, boundary_offset=0.0, table_init_std=0.1):
...
def main():
    ...
    ap.add_argument("--table-init-std", type=float, default=0.0176777,
    ...
    ap_ = actor_init(ka, a.buckets, a.ndet, a.tph, a.heads, a.delay_init_std,
                     a.boundary_offset, a.table_init_std)
    ...
    print(f"MHL-LIF SAC actor heads={a.heads} tph={a.tph} n_det={a.ndet} "
          ...
          f"table_init_std={a.table_init_std:.5f} | temperatures "
