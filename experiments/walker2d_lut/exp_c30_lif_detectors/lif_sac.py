...
WHAT IS NOT MATCHED: parameter count. At nap6/tph32 the actor is 87,361 params --
detector bank 62,785 (of which `P`, the ordered-pair channel, is 55,488) plus table
24,576 -- against 49,152 for the LUT actors of exp_c13/c18/c29. That is 1.8x, and it is
NOT a param-matched comparison. The natural anchor is exp_c18's hyperplane cell at the
same nap6/tph32 shape: 6 seeds, deterministic, 4308.0 +/- 500.1.
...
import jax_lif_mhl as LIF        # noqa: E402
