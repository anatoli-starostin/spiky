...
def main():
    ...
    print(f"run   cfg {RUN}  freeze_temperature=True  delay_init_std={DELAY_INIT_STD}  boundary_offset={BOUNDARY_OFFSET} table_init_std={TABLE_INIT_STD} share_betas={SHARE_BETAS}")
