...
BATCH = 24
DELAY_OFFSET = 2.0        # exp_c40: per-detector additive delay bias
INPUT_DIM = 17
N_OUT = 12
...
def main():
    ...
    print(f"run   cfg {RUN}  freeze_temperature=True  delay_init_std=4  delay_offset={DELAY_OFFSET}")
    one_case("run", LIFMultiHeadLUT(**RUN, freeze_temperature=True,
                                    delay_init_std=4.0, delay_offset=DELAY_OFFSET),
             RUN, 11, dump)
