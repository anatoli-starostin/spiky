...
BENCH = os.path.dirname(HERE)                       # experiments/ffn_replacement/benchmark
R = os.path.join(os.path.dirname(BENCH), 'runs')   # experiments/ffn_replacement/runs
REPO = os.path.dirname(os.path.dirname(os.path.dirname(R)))   # repo root
