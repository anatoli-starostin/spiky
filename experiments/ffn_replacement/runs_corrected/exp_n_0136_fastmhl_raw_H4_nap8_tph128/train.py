...
# (`git show f1dd5e9d:experiments/ffn_replacement/runs_corrected/exp_n_0136_fastmhl_raw_H4_nap8_tph128/train.py`).
# =============================================================================
...
assert FFN_LUT_KIND in ('compression', 'fastmhl_raw'), FFN_LUT_KIND
