...
Usage:
  sbox .venv/bin/python experiments/ffn_replacement/tools/measure_flops_bandwidth.py \
       --exp experiments/ffn_replacement/runs/exp_n_0121_ffnsw_nap8_tph128_16k
