...
PIN_SPIKY = "5a16470d6c5f331598165e1c04facee4844c14ce"  # abl_47+headdrop fork at the quant-path head-dropout feature commit 5a16470d (adds head_dropout on both float and p2_int8 read paths, off by default)
...
expect = dict(device_batch_size=12, total_batch_size=24576, seq_len=512, lr=0.0003, weight_decay=0.1, lr_warmup_fraction=0.1,
              ...
              lut_inner_out_dim=48, depth=6, n_embd=384, lut_head_dropout_rate=0.2)
