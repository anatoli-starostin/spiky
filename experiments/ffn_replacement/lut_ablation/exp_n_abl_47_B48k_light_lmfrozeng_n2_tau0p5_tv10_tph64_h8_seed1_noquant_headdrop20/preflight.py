...
PIN_SPIKY = "2b33d337429944a123369e6b26795330ccd1e0d4"  # headdrop20 fork at the head-dropout feature commit 2b33d337 (adds LightMHL head_dropout_rate on the scored per-table gate, off by default). Float LUT read otherwise unchanged.
