...
# exp_g_0029: the FFN slot IS a HyperplaneMHL at full model dim -- NO compress and NO
# decompress Linear, so every table cell stores a full 384-dim output vector. That is
# what makes the tables ~8x larger than exp_n_0121's 48-dim cells. See
# local_hyperplane_ffn.py; shared src/spiky/lutorch/ untouched.
from local_hyperplane_ffn import PureHyperplaneMHL as CompressionMultiHeadLUT
