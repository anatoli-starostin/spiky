"""PureHyperplaneMHL — HyperplaneMHL as a DIRECT replacement for the FFN LUT slot.
...
class PureHyperplaneMHL(nn.Module):
    """HyperplaneMHL at full model dim, no compress/decompress.
