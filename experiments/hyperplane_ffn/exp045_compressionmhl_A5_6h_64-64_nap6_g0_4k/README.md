# exp045_compressionmhl_A5_6h_64-64_nap6_g0_4k

FFN-slot sweep run A5_6h_64-64_nap6_g0 (untied unembedder). x = x + 0*Linear(384->384)(h) + CompressionMultiHeadLUT(h), h=ln2(x); independent per-head (joint_head_compression=False), hard FastMHL.
