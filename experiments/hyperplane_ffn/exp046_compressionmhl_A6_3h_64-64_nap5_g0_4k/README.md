# exp046_compressionmhl_A6_3h_64-64_nap5_g0_4k

FFN-slot sweep run A6_3h_64-64_nap5_g0 (untied unembedder). x = x + 0*Linear(384->384)(h) + CompressionMultiHeadLUT(h), h=ln2(x); independent per-head (joint_head_compression=False), hard FastMHL.
