...
def _make_out(seed_offset):
    return CompressionMultiHeadLUT(
        input_dim=H * d_v, output_dim=E, inner_in_dim=_C_IN, inner_out_dim=_C_IN,
        nap=_C_NAP, tph=_C_TPH, n_heads=_OUT_H,
        forward_mode="hard", use_bf16=True,
...
print(f'out_proj = CompressionMHL(in={H*d_v}->out={E}, inner_in={_C_IN}, inner_out={_C_IN}, '
      f'nap={_C_NAP}, tph={_C_TPH}, n_heads={_OUT_H}) -> [N,{E}]')
