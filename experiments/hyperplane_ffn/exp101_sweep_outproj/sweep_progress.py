"""Consolidated Slack progress bar for the exp101 out_proj sweep (ONE message for all 12
...
finalizes with a top-3 ranking when all 12 complete. Launch with BAR_HANDLE set.
"""
...
for _ in range(1400):                       # ~ up to 11.6h at 30s cadence
    ...
    for sub in glob.glob(os.path.join(D, 'in*_tph*/')):
