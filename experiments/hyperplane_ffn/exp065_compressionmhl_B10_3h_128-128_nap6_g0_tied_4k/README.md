# exp065_compressionmhl_B10_3h_128-128_nap6_g0_tied_4k

FFN-slot sweep run B10_3h_128-128_nap6_g0_tied (tied unembedder). x = x + 0*Linear(384->384)(h) + CompressionMultiHeadLUT(h), h=ln2(x); independent per-head (joint_head_compression=False), hard FastMHL.
