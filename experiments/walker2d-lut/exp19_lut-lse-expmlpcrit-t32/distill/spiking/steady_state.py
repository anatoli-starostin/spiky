...
from es_harness import (D_MAX, D_MIN, GROUP_SIZE, LatencyEncoder, N_EXC, N_INH, N_IN,
                        N_OUT, N_TICKS, RES_W_INH, delay_metas, group_aligned_weights,
                        kendall_tau_b, run_episode)
from es_sweep import own_null
...
def main():
    ...
    # Rebind the pool sizes everywhere they are cached. N_EXC/N_INH come from es_harness and
