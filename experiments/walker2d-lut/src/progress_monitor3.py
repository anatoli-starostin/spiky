...
BENCH = "/home/astarostin/projects/walker2d_gpu/bench3"
TASK = "ed1a49ca"
SEEDS = [0, 1, 2]
TOTAL = 384
...
def main():
    h = progress.progress_start("PPO 3-seeds PARALLEL · N=8192 · physics-graph · one H100",
                                task=TASK, width=12, stats="starting… (seeds 0/1/2 concurrent, 384 upd each)")
    t0 = time.time()
