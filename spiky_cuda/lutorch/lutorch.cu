...
public:
    ...
    #endif
    {
        ...
        profiler.register_operation_type(
            ...
            "lutorch::anchor_pairs_lookup_eval_forward_na1"
        );
        #endif
        #endif
    }
    ...
    anchor_pairs_lookup_forward_na1(
        ...
        torch::Tensor anchor1_ids = torch::empty({batch_size, n_tables, 1}, opts_i64);
        torch::Tensor anchor2_ids = torch::empty({batch_size, n_tables, 1}, opts_i64);
