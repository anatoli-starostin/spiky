...
//        #endif
        ...
        GRID_CALL_ON_STREAM_NO_SHARED_MEM(
            numBlocks, gather_gradients_fully_connected_old, tpb_opt, streams[0],
            r_weights,
            r_output_gradients,
            r_lookup_indices,
            nullptr,
        ...
        GRID_CALL_ON_STREAM_NO_SHARED_MEM(
            numBlocks, gather_gradients_fully_connected_old, tpb_opt, streams[1],
            r_weights,
            r_output_gradients,
            r_lookup_indices,
            r_min_anchor_delta_indices,
        ...
        PROF_START(LUT_RUNTIME_BACKWARD_GATHER_FC_X_PROFILER_OP);
        GRID_CALL_NO_SHARED_MEM(
            numBlocks, gather_gradients_fully_connected_old, tpb_opt,
            r_weights,
            r_output_gradients,
            r_lookup_indices,
            nullptr,
