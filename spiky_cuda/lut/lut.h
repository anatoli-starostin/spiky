...
#define LUT_RUNTIME_BACKWARD_ZERO_GRAD_PROFILER_OP N_CONNECTIONS_MANAGER_PROFILER_OPS + 5
#define LUT_RUNTIME_BACKWARD_FIRE_DETECTORS_PROFILER_OP N_CONNECTIONS_MANAGER_PROFILER_OPS + 6
#define LUT_RUNTIME_BACKWARD_GATHER_GRADIENTS_PROFILER_OP N_CONNECTIONS_MANAGER_PROFILER_OPS + 7
#define LUT_RUNTIME_BACKWARD_GATHER_FC_PROFILER_OP N_CONNECTIONS_MANAGER_PROFILER_OPS + 8
#define LUT_RUNTIME_BACKWARD_GATHER_FC_X_PROFILER_OP N_CONNECTIONS_MANAGER_PROFILER_OPS + 9
#define LUT_RUNTIME_BACKWARD_GATHER_FC_X_BAR_PROFILER_OP N_CONNECTIONS_MANAGER_PROFILER_OPS + 10
#define LUT_RUNTIME_BACKWARD_GATHER_FC_W_PROFILER_OP N_CONNECTIONS_MANAGER_PROFILER_OPS + 11
#define LUT_RUNTIME_BACKWARD_PROPAGATE_DETECTORS_PROFILER_OP N_CONNECTIONS_MANAGER_PROFILER_OPS + 12
#define N_LUT_PROFILER_OPS (N_CONNECTIONS_MANAGER_PROFILER_OPS + 13)
#endif
